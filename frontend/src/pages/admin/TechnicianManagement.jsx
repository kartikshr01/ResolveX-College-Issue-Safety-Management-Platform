...
const TechnicianManagement = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.error(
        "Failed to load technician management data:",
        err
      );
  ...
  const handleEditTechnician = (technician) => {
    ...
    setEditForm({
      ...
      availability:
        technician.availability !== undefined
  ...
  const handleConvertStudent = async (event) => {
    ...
    try {
      ...
      console.log(
        "CONVERT STUDENT USER ID:",
        userId
      );

      console.log(
        "CONVERT STUDENT PAYLOAD:",
        payload
      );
  ...
  return (
    <main className="technician-content">
      ...
      <header className="technician-header">
        <div>
          <p className="technician-eyebrow">
            MANAGEMENT
          </p>
          ...
          <p className="technician-subtitle">
            Manage technicians and convert student
            accounts into technicians.
          </p>
        </div>
        ...
        <div className="technician-modal-overlay">
          <div className="technician-modal">
            ...
            >
              ...
              {/* DEPARTMENT */}
              <div className="form-group">
                <label htmlFor="convert-department">
                  Department
                </label>
