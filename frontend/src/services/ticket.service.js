...
export const getTicketForNotification = async (ticketId) => {
  const response = await api.get(`/tickets/notification/${ticketId}`);
...
export const getTechnicianHistory = async () => {
  const response = await api.get("/tickets/technician/history");
...
export const getTechnicianTicketById = async (ticketId) => {
  const response = await api.get(`/tickets/technician/${ticketId}`);
...
export const getTicketById = async (ticketId) => {
  const response = await api.get(`/tickets/my/${ticketId}`);
...
export const deleteTicket = async (ticketId) => {
  const response = await api.delete(`/tickets/my/${ticketId}`);
